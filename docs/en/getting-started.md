...
- It follows standardized **Archiving Instructions** to analyze what was done, consolidate Module Living Specs, and update the Global Constitution if new systemic architectural decisions have emerged.
