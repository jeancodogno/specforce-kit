...
- **`modules/`**: A directory containing domain-specific living specifications (business rules, canonical use cases, and technical contracts) maintained by AI agents.
